...
COMPANY_URLS = [
    ...
    "https://sozhaafoundation.com/about-us",
    "https://sozhaafoundation.com/our-services",
    "https://sozhaafoundation.com/our-works",
    "https://sozhaafoundation.com/get-involved",
    "https://sozhaafoundation.com/contact-us",
]
...
def fetch_snippets(urls, chars=2000):
    snippets = []
    headers = {"User-Agent": "SozhaaBot/1.0 (+https://sozhaafoundation.com)"}
    for u in urls:
        try:
...
def build_system_prompt(snippets):
    ...
    return (
        ...
        "(sozhaafoundation.com). Answer only about the company, services, works, involved and contact information. "
...
def call_gemini(system_prompt, history, user_message):
    ...
    if "service" in user_message.lower() or "services" in user_message.lower():
        return (
            "Sozhaa Foundation provides a world wide range of Founding services 🚀.\n"
...
async def chat_endpoint(payload: ChatPayload, background_tasks: BackgroundTasks):
    ...
    if "[User ended the chat]" in user_msg:
        assistant_text = "✅ Thank you for chatting with Sozhaa Foundation 🚀\nOur team will contact you soon."
        ...
        if payload.user_details.get("email"):
            ...
            send_email_with_attachment(payload.user_details["email"], "Sozhaa Foundation — Chat Summary", thank_you_html, TRANSCRIPT_EXCEL)
